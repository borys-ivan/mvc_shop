...
<div id="wrapper">
    <section id="intro" class="wrapper style1 fullscreen fade-up">
        <div class="inner">
            ...
            foreach ($result['productID'] as $row) {
                ...
                <form method="post" action="#">
                    ...
                    <center><p><textarea type="text" rows="5"
                                         name="specifications"/><? echo $row['specifications']; ?></textarea></p>
                    </center>
                    <h4>Ціна</h4>
                    ...
                    <h4>Новинка</h4>
                    <select name="new">
                        <option value="<? echo $row['new']; ?>"
                                selected="selected"><? echo $row['name_new']; ?></option>
                    ...
                    <h4>Наявність</h4>
                    <select name="status">
                        <option value="<? echo $row['status']; ?>"
                                selected="selected"><? echo $row['name_status']; ?></option>
